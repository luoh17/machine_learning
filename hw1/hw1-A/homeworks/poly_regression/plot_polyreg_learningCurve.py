...
def plotLearningCurve(errorTrain, errorTest, reg_lambda, degree):
    """
    ...
    plt.title(f"Learning Curve (d={degree}, lambda={reg_lambda})")
...
def generateLearningCurve(X, y, degree, reg_lambda):
    ...
    for train_index, test_index in loo.split(X):
        ...
        (errTrain, errTest) = learningCurve(
            X_train, y_train, X_test, y_test, reg_lambda, degree
        )
